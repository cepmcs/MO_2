...
Uso:
    ...
    python experimento_nsga3.py --pop_size 200 --run_id 0 --crossover pcx --mutation gauss
    python experimento_nsga3.py --pop_size 200 --crossover pcx --mutation gauss --generate_summary
"""

#!/bin/bash
#SBATCH --job-name=MOEAD_MO
#SBATCH --output=salida_moead.out
#SBATCH --error=error_moead.err
...
# ─── Configuración MOEA/D ───────────────────────────────────────────────────
ALG="MOEAD"
SCRIPT="experimento_moead.py"
POP_SIZES=(300)
N_RUNS=20
...
echo "======================================================"
echo "  MOEA/D — Optimización Multi-Objetivo"
...
echo "======================================================"
echo "  ¡MOEA/D COMPLETADO! (${#OPERATORS[@]} combinaciones de operadores)"
echo "======================================================"

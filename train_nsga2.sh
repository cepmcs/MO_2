...
echo "======================================================"
echo "  NSGA-II — Optimización Multi-Objetivo"
...
echo "======================================================"
echo "  ¡NSGA-II COMPLETADO! (${#OPERATORS[@]} combinaciones de operadores)"
echo "======================================================"
